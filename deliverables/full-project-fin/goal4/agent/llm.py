...
def provenance_note(source):
    ...
    if source == "groq":
        return (base + "the reason and fix below were written by an LLM and "
                "may be inaccurate - please verify before acting.")
    return (base + "the reason and fix below were generated from a fixed "
            "template (no LLM).")
