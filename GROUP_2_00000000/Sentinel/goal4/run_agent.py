...
def main():
    ...
    if result["y_pred"] == 1:
        ...
        # Second tool: optional LLM hint for the human (advisory only).
        if result.get("advisory_note"):
            print("LLM hint   :", result["advisory_note"],
                  "(verify independently - not part of the decision)")
