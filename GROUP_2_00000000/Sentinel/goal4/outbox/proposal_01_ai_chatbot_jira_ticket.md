TICKET: Remediate RAI-02, RAI-05, RAI-01, RAI-07 in proposal_01_ai_chatbot
Type    : Compliance
Priority: High
...
- RAI-02 (High)
    ...
    Action: Add the control required by RAI-02 and state it explicitly in the proposal.
- RAI-05 (High)
...
Note    : The Red-Flag decision comes from the trained TF-IDF model; the reason and fix below were generated from a fixed template (no LLM).
